...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   190     // (°C) Minimum temperature to enable hotend protection
...
#define COOLER_AUTO_FAN_PIN -1 //FAN_PIN is the part cooling fan for the first extruder. I am not aware of any way to tell Marlin to use something else.
...
#define ASSISTED_TRAMMING
  ...
  //#define TRAMMING_POINT_XY { {  35, 35 }, { 300,  35 }, { 300, 320 }, { 35, 335 } }
  #define TRAMMING_POINT_XY { {  35, 60 }, { 340,  60 }, { 340, 340 }, { 35, 340 } }
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       13  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    13  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
